...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        salida.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        ...
        salida.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        try {
            if (!(salida.getText().isEmpty()) && !(error)) {
                operando1 = Double.parseDouble(salida.getText());
                salida.setText("");
                operador = "+";
            }
        } catch (Exception e) {
            salida.setText("Ha ocurrido un error");
            error = true;
        }
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        try {
            if (!(salida.getText().isEmpty()) && !(error)) {
                ...
                operando2 = Double.parseDouble(salida.getText());
                double resultado = 0;
                boolean divisionEntreCero = false;
                ...
                if (divisionEntreCero) {
                    salida.setText("No se puede dividir entre cero");
                    error = true;
                } else {
                    String numeros = Double.toString(resultado);
                    if (resultado % 1 == 0) {
                        numeros = numeros.substring(0, numeros.length() - 2);
                    }
                    salida.setText(numeros);
                }
            }
        } catch (Exception e) {
            salida.setText("Ha ocurrido un error");
    ...
    private void jButton27ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton27ActionPerformed
        try {
            if (!(salida.getText().contains(".")) && !(salida.getText().isEmpty()) && !(error)) {
